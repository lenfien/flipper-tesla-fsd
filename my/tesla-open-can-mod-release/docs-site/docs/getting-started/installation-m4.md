---
title: Adafruit Feather M4 CAN Installation
sidebar_position: 3
---
...
| Enhance Auto Tesla Gen 2 Cable | ~30 EUR | [enhauto.com](https://www.enhauto.com/products/tesla-gen-2-cable) |
| 12V/24V to 5V USB-C DC/DC Converter | ~5 EUR | [aliexpress.com](https://nl.aliexpress.com/item/1005008928142771.html) |

:::note Enhance Auto Cable
...
:::tip Installation Video
For a detailed video guide on how to access the X179 connector and plug in the cable, see [this installation video by Enhance Auto](https://youtube.com/watch?v=ifwJNZgykVI).
:::
...
:::note Next Steps
After successful installation, see the [Features](../features/fsd-activation.md) section to configure and enable specific features like FSD Activation, Nag Suppression, Speed Profiles, etc.
:::
